...
import  servicecatalogueCreate from "@/services/magic-meetings/endpoints/servicecatalogue/create";
...
export default function TestServiceComponent() {
    ...
    const result = await servicecatalogueCreate(transactionId,input);
    if (result.hasError) {
