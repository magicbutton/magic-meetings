...
import  servicecatalogueDelete from "@/services/magic-meetings/endpoints/servicecatalogue/delete";
...
export default function TestServiceComponent() {
    ...
    const result = await servicecatalogueDelete(transactionId,input);
    if (result.hasError) {
