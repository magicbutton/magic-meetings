...
import  servicecatalogueSearch from "@/services/magic-meetings/endpoints/servicecatalogue/search";
...
export default function TestServiceComponent() {
    ...
    const result = await servicecatalogueSearch(transactionId,input);
    if (result.hasError) {
