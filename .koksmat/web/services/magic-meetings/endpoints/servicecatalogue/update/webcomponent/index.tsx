...
import  servicecatalogueUpdate from "@/services/magic-meetings/endpoints/servicecatalogue/update";
...
export default function TestServiceComponent() {
    ...
    const result = await servicecatalogueUpdate(transactionId,input);
    if (result.hasError) {
