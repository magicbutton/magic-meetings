...
import  servicecategoryCreate from "@/services/magic-meetings/endpoints/servicecategory/create";
...
export default function TestServiceComponent() {
    ...
    const result = await servicecategoryCreate(transactionId,input);
    if (result.hasError) {
