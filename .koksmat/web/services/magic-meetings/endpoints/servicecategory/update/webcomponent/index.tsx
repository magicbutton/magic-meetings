...
import  servicecategoryUpdate from "@/services/magic-meetings/endpoints/servicecategory/update";
...
export default function TestServiceComponent() {
    ...
    const result = await servicecategoryUpdate(transactionId,input);
    if (result.hasError) {
