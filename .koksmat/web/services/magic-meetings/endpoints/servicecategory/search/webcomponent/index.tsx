...
import  servicecategorySearch from "@/services/magic-meetings/endpoints/servicecategory/search";
...
export default function TestServiceComponent() {
    ...
    const result = await servicecategorySearch(transactionId,input);
    if (result.hasError) {
