...
import  servicecategoryDelete from "@/services/magic-meetings/endpoints/servicecategory/delete";
...
export default function TestServiceComponent() {
    ...
    const result = await servicecategoryDelete(transactionId,input);
    if (result.hasError) {
