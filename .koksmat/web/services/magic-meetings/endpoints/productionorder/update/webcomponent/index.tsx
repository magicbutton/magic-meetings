...
import  productionorderUpdate from "@/services/magic-meetings/endpoints/productionorder/update";
...
export default function TestServiceComponent() {
    ...
    const result = await productionorderUpdate(transactionId,input);
    if (result.hasError) {
