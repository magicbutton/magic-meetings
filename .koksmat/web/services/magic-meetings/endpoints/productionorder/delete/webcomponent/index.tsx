...
import  productionorderDelete from "@/services/magic-meetings/endpoints/productionorder/delete";
...
export default function TestServiceComponent() {
    ...
    const result = await productionorderDelete(transactionId,input);
    if (result.hasError) {
