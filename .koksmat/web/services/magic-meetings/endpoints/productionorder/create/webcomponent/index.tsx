...
import  productionorderCreate from "@/services/magic-meetings/endpoints/productionorder/create";
...
export default function TestServiceComponent() {
    ...
    const result = await productionorderCreate(transactionId,input);
    if (result.hasError) {
