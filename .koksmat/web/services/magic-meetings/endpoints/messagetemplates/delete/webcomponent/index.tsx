...
import  messagetemplatesDelete from "@/services/magic-meetings/endpoints/messagetemplates/delete";
...
export default function TestServiceComponent() {
    ...
    const result = await messagetemplatesDelete(transactionId,input);
    if (result.hasError) {
