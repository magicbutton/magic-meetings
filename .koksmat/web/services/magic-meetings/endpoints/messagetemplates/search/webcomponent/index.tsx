...
import  messagetemplatesSearch from "@/services/magic-meetings/endpoints/messagetemplates/search";
...
export default function TestServiceComponent() {
    ...
    const result = await messagetemplatesSearch(transactionId,input);
    if (result.hasError) {
