...
import  messagetemplatesCreate from "@/services/magic-meetings/endpoints/messagetemplates/create";
...
export default function TestServiceComponent() {
    ...
    const result = await messagetemplatesCreate(transactionId,input);
    if (result.hasError) {
