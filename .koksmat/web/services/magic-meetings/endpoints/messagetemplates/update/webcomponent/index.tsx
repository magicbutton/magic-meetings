...
import  messagetemplatesUpdate from "@/services/magic-meetings/endpoints/messagetemplates/update";
...
export default function TestServiceComponent() {
    ...
    const result = await messagetemplatesUpdate(transactionId,input);
    if (result.hasError) {
