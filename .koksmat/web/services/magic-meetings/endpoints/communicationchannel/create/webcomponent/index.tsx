...
import  communicationchannelCreate from "@/services/magic-meetings/endpoints/communicationchannel/create";
...
export default function TestServiceComponent() {
    ...
    const result = await communicationchannelCreate(transactionId,input);
    if (result.hasError) {
