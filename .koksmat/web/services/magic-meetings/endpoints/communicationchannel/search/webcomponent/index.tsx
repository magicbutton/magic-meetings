...
import  communicationchannelSearch from "@/services/magic-meetings/endpoints/communicationchannel/search";
...
export default function TestServiceComponent() {
    ...
    const result = await communicationchannelSearch(transactionId,input);
    if (result.hasError) {
