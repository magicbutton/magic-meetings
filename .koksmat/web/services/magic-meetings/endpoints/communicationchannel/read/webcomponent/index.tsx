...
import  communicationchannelRead from "@/services/magic-meetings/endpoints/communicationchannel/read";
...
export default function TestServiceComponent() {
    ...
    const result = await communicationchannelRead(transactionId,input);
    if (result.hasError) {
