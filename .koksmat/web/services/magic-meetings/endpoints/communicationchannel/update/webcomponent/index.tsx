...
import  communicationchannelUpdate from "@/services/magic-meetings/endpoints/communicationchannel/update";
...
export default function TestServiceComponent() {
    ...
    const result = await communicationchannelUpdate(transactionId,input);
    if (result.hasError) {
