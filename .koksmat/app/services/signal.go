...
if (len(payload.Args) < 2) {
    ...
    if (err != nil) {
        ...
        ServiceResponseError(req, fmt.Sprintf("Error calling SignalRead: %s", err))
...
if (len(payload.Args) < 2) {
    ...
    if (err != nil) {
        log.Println("Error", err)
        ServiceResponseError(req, fmt.Sprintf("Error calling SignalCreate: %s", err))
...
if (len(payload.Args) < 2) {
    ...
    if (err != nil) {
        log.Println("Error", err)
        ServiceResponseError(req, fmt.Sprintf("Error calling SignalUpdate: %s", err))
...
if (len(payload.Args) < 2) {
    ...
    return
            ...
            if (err != nil) {
                log.Println("Error", err)
                ServiceResponseError(req, fmt.Sprintf("Error calling SignalDelete: %s", err))
...
if (len(payload.Args) < 2) {
    ...
    if (err != nil) {
        log.Println("Error", err)
        ServiceResponseError(req, fmt.Sprintf("Error calling SignalSearch: %s", err))
