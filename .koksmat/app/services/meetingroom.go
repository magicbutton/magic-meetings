...
if (len(payload.Args) < 2) {
    ...
    if (err != nil) {
        ...
        ServiceResponseError(req, fmt.Sprintf("Error calling MeetingroomRead: %s", err))
...
if (len(payload.Args) < 2) {
    ...
    if (err != nil) {
        log.Println("Error", err)
        ServiceResponseError(req, fmt.Sprintf("Error calling MeetingroomCreate: %s", err))
...
if (len(payload.Args) < 2) {
    ...
    if (err != nil) {
        log.Println("Error", err)
        ServiceResponseError(req, fmt.Sprintf("Error calling MeetingroomUpdate: %s", err))
...
if (len(payload.Args) < 2) {
    ...
    return
            ...
            if (err != nil) {
                log.Println("Error", err)
                ServiceResponseError(req, fmt.Sprintf("Error calling MeetingroomDelete: %s", err))
...
if (len(payload.Args) < 2) {
    ...
    if (err != nil) {
        log.Println("Error", err)
        ServiceResponseError(req, fmt.Sprintf("Error calling MeetingroomSearch: %s", err))
